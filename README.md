...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/lisc-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10368&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/lisc-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `lisc` can be installed with:

```
conda install lisc
```

It is possible to list all of the versions of `lisc` available on your platform with:
